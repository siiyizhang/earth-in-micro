      ...
      <div style={{
        ...
        <div style={{ display: "flex", flexDirection: isMobile ? "column" : "row", gap: isMobile ? 40 : 64, alignItems: "flex-start" }}>
          ...
          <div style={{ flex: "1 1 0", fontSize: isMobile ? 15 : 16, lineHeight: 1.85, color: "rgba(255,255,255,0.7)", letterSpacing: "0.01em" }}>
            Eureka Microscope was founded by Siyi Zhang, an environmental scientist-turned-entrepreneur fascinated by the invisible world, and Yu Liu, a quantum engineer with a passion for making cutting-edge technology accessible to more people. Siyi became captivated by the micro world during her thesis on marine plankton at ETH Zürich. Inspired by the <a href="https://www.planktoscope.org" target="_blank" rel="noopener noreferrer" style={{ color: "rgba(255,255,255,0.6)", textDecorationColor: "rgba(255,255,255,0.3)" }}>PlanktoScope project</a> — an open-source plankton imaging device — she saw the potential to bring this kind of optics into a portable, consumer-grade product. Yu, her longtime friend, was instantly captivated by the idea. Together, they set out to build something the world had never seen: a portable microscopic camera that reveals nature in a completely new dimension.
          </div>

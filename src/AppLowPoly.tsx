  ...
  return (
    <div style={{ margin: isMobile ? "0 8px" : "0 24px", background: "#f5f3ee", borderRadius: 24, overflow: "hidden" }}>
      ...
      <div style={{ padding: `clamp(28px,4vh,52px) ${PAD}`, textAlign: "center" }}>
        <h2 style={{ fontFamily: fonts.serif, fontWeight: 100, fontSize: "clamp(28px,4vw,56px)", color: colors.text, margin: 0, letterSpacing: "-0.01em", lineHeight: 1.1 }}>
      ...
      <div style={{ display: "flex", flexDirection: isMobile ? "column" : "row", gap: 32, alignItems: isMobile ? "stretch" : "flex-end", width: "100%" }}>
        ...
        {/* Left: 9:16 video — hidden on mobile */}
        {!isMobile && (
          <div style={{ display: "flex", flexDirection: "column", gap: 10, alignSelf: "stretch", flex: "0 0 auto", width: "22%" }}>
        ...
        <div style={{ flex: 1, display: "flex", flexDirection: "column", gap: 16 }}>
          ...
          <div style={{ flex: "0 0 auto" }}>
            <div style={{ fontFamily: fonts.sans, fontSize: isMobile ? 20 : 25, fontWeight: 600, color: colors.text, marginBottom: 8 }}>Lab-grade Image Quality</div>
            <div style={{ fontFamily: fonts.sans, fontSize: isMobile ? 14 : 16, color: colors.textMid, lineHeight: 1.65 }}>
            ...
            <div style={{ display: "flex", gap: 4, flexShrink: 0, alignItems: "stretch" }}>
              {comparisons.map(c => (
                <div key={c.src} style={{
                  ...
                  border: "none",
                  boxShadow: c.highlight ? `inset 0 0 0 2px ${colors.teal}` : "inset 0 0 0 1px rgba(26,42,60,0.08)",
                  background: "#ffffff",
                }}>
      ...
      <div style={{ minHeight: 280, display: "flex", flexDirection: isMobile ? "column" : "row", alignItems: isMobile ? "stretch" : "center", justifyContent: "center", padding: isMobile ? `32px ${PAD}` : `0 ${PAD}`, gap: isMobile ? 20 : 48 }}>
        ...
        <div style={{ flex: "0 0 auto", maxWidth: isMobile ? "100%" : 400, display: "flex", flexDirection: "column", justifyContent: "center" }}>
          <div style={{ fontFamily: fonts.sans, fontSize: isMobile ? 20 : 25, fontWeight: 600, color: colors.text, marginBottom: 14 }}>Durable & Portable</div>
          <div style={{ fontFamily: fonts.sans, fontSize: isMobile ? 14 : 16, color: colors.textMid, lineHeight: 1.7 }}>
      ...
      <div style={{ minHeight: 280, display: "flex", flexDirection: isMobile ? "column" : "row", alignItems: isMobile ? "stretch" : "center", justifyContent: "center", padding: `clamp(32px,6vh,72px) ${PAD}`, gap: isMobile ? 20 : 48 }}>
        <div style={{ flex: "0 0 auto", maxWidth: isMobile ? "100%" : 400, display: "flex", flexDirection: "column", justifyContent: "center" }}>
          <div style={{ fontFamily: fonts.sans, fontSize: isMobile ? 20 : 25, fontWeight: 600, color: colors.text, marginBottom: 14 }}>Multi-mode Illumination</div>
          <div style={{ fontFamily: fonts.sans, fontSize: isMobile ? 14 : 16, color: colors.textMid, lineHeight: 1.7 }}>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
        ...
        <div style={{ background: cardBg, borderRadius: cardRadius, display: "flex", flexDirection: isMobile ? "column" : "row", minHeight: isMobile ? 0 : 320, padding: 12, gap: 12 }}>
          <div style={{ flex: 1, padding: isMobile ? "20px 16px" : "24px 28px", display: "flex", flexDirection: "column", justifyContent: "center", gap: 14 }}>
            <div style={{ fontFamily: fonts.serif, fontWeight: 100, fontSize: "clamp(18px,2vw,28px)", color: colors.text, lineHeight: 1.2 }}>Pick it up and explore</div>
            <div style={{ fontFamily: fonts.sans, fontSize: isMobile ? 14 : 16, color: colors.textMid, lineHeight: 1.75, fontWeight: 300 }}>
        ...
        <div style={{ background: cardBg, borderRadius: cardRadius, display: "flex", flexDirection: isMobile ? "column" : "row", minHeight: isMobile ? 0 : 280, padding: 12, gap: 12 }}>
          ...
          <div style={{ flex: 1, padding: isMobile ? "16px 12px" : "24px 28px", display: "flex", flexDirection: "column", justifyContent: "center", gap: 14 }}>
            <div style={{ fontFamily: fonts.serif, fontWeight: 100, fontSize: "clamp(18px,2vw,28px)", color: colors.text, lineHeight: 1.2 }}>Built-in guides in the app</div>
            <div style={{ fontFamily: fonts.sans, fontSize: isMobile ? 14 : 15, color: colors.textMid, lineHeight: 1.75, fontWeight: 300 }}>
        ...
        <div style={{ background: cardBg, borderRadius: cardRadius, display: "flex", flexDirection: isMobile ? "column" : "row", minHeight: isMobile ? 0 : 480, padding: 12, gap: 12 }}>
          <div style={{ flex: 1, padding: isMobile ? "20px 16px" : "24px 28px", display: "flex", flexDirection: "column", justifyContent: "center", gap: 20 }}>
            <div style={{ fontFamily: fonts.serif, fontWeight: 100, fontSize: "clamp(18px,2vw,28px)", color: colors.text, lineHeight: 1.2 }}>Different ages, different depth.</div>
            <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
              {ageGroups.map(g => (
    ...
    return (
      <div style={{ width: "100vw", background: "#ffffff" }}>
        <div style={{ padding: "clamp(28px,4vh,48px) 24px clamp(20px,2.5vh,32px)", textAlign: "center" }}>
          <div style={{ fontFamily: fonts.serif, fontWeight: 100, fontSize: "clamp(28px,4vw,58px)", color: colors.text, lineHeight: 1.15, letterSpacing: "-0.01em" }}>
        ...
        <div style={{ position: "relative", height: 300, margin: "0 16px", borderRadius: 16, overflow: "hidden" }}>
          ...
          <div style={{ position: "absolute", bottom: 0, left: 0, right: 0, padding: "0 24px 24px" }}>
            <h2 style={{ fontFamily: fonts.serif, fontWeight: 100, fontSize: "clamp(22px,2.2vw,34px)", color: "#ffffff", margin: "0 0 8px" }}>{activeScenario.name}</h2>
            <p style={{ fontFamily: fonts.sans, fontSize: 13, lineHeight: 1.7, color: "rgba(255,255,255,0.65)", margin: 0, fontWeight: 300 }}>{activeScenario.micro.desc}</p>
          </div>
        </div>
            ...
            {!isMobile && [
              ...
              <a
                ...
                style={{
                  ...
                  color: navVisible ? "rgba(26,42,60,0.7)" : "rgba(255,255,255,0.75)",
                  textDecoration: "none",
        ...
        <div style={{ width: "100vw", height: "100vh", overflow: "hidden", background: "#ffffff", display: "flex", flexDirection: "column", position: "relative" }}>
          ...
          <div style={{ position: "relative", flex: "0 0 62%", overflow: "hidden" }}>
            ...
            <div style={{
              position: "absolute", inset: 0,
              background: isMobile
                ? "linear-gradient(to top, rgba(8,14,24,0.85) 0%, rgba(8,14,24,0.6) 50%, rgba(8,14,24,0.3) 100%)"
                : "linear-gradient(to right, rgba(8,14,24,0.88) 0%, rgba(8,14,24,0.72) 2%, rgba(8,14,24,0.0) 60%)",
              display: "flex",
              alignItems: isMobile ? "flex-end" : "center",
            }}>
              <div style={{ padding: isMobile ? "0 20px 24px" : `0 0 0 clamp(32px, 6vw, 80px)`, maxWidth: isMobile ? "100%" : "42vw" }}>
                <h1 style={{
                ...
                <p style={{
                  fontFamily: FONTS.sans,
                  fontSize: isMobile ? 13 : "clamp(12px, 1.1vw, 15px)",
                  lineHeight: 1.7,
        ...
        <div style={{ padding: isMobile ? "0 12px" : "0 24px" }}>
          ...
          <div id="cta-edu" style={{
            ...
            <div style={{ textAlign: "center" }}>
              ...
              <div style={{ fontFamily: FONTS.serif, fontWeight: 100, fontSize: "clamp(28px,3.6vw,52px)", color: "rgba(20,30,50,0.85)", letterSpacing: "-0.01em", lineHeight: 1.15 }}>
                Early Bird Price
              </div>
            ...
            <div style={{ display: "flex", flexDirection: isMobile ? "column" : "row", gap: isMobile ? 40 : "clamp(24px,5vw,80px)", width: "100%", maxWidth: 860, alignItems: "flex-start" }}>
              ...
              <div style={{ flex: 1, width: isMobile ? "100%" : undefined }}>
                ...
                <div style={{ fontFamily: FONTS.sans, fontSize: 14, color: "rgba(20,30,50,0.5)", lineHeight: 1.7, fontWeight: 300, marginBottom: 20 }}>
          ...
          <div style={{
            ...
            <div style={{ fontFamily: FONTS.sans, fontWeight: 400, fontSize: "clamp(10px,0.8vw,12px)", letterSpacing: "0.18em", textTransform: "uppercase", color: "rgba(26,42,60,0.3)" }}>Supported by</div>
            <img src="/sponsor/SPH_logo.avif" alt="SPH" style={{ height: 36, opacity: 0.5 }} />
            <img src="/sponsor/logo_VENTUREKICK_cmyk-1.avif" alt="Venture Kick" style={{ height: 36, opacity: 0.5 }} />
            <img src="/sponsor/IN_Logo.svg" alt="Innosuisse" style={{ height: 36, opacity: 0.5 }} />
          </div>
          ...
          <div style={{
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 40, maxWidth: 900, width: "100%" }}>
              {/* Brand */}
              <div>
                <img src="/Black text.png" alt="Earth in Micro" style={{ height: 24, display: "block", marginBottom: 12 }} />
                <div style={{ fontFamily: FONTS.sans, fontWeight: 300, fontSize: "clamp(13px,1vw,15px)", color: "rgba(26,42,60,0.45)", lineHeight: 1.6 }}>
              ...
              <div style={{ display: "flex", gap: isMobile ? 32 : "clamp(32px,6vw,80px)", flexWrap: "wrap" }}>
                {/* Contact */}
                <div>
                  <div style={{ fontFamily: FONTS.sans, fontWeight: 400, fontSize: "clamp(10px,0.8vw,12px)", letterSpacing: "0.18em", textTransform: "uppercase", color: "rgba(26,42,60,0.5)", marginBottom: 20 }}>Contact</div>
                  <div style={{ fontFamily: FONTS.sans, fontWeight: 300, fontSize: "clamp(13px,1vw,15px)", color: "rgba(26,42,60,0.45)", lineHeight: 2 }}>
                    Clausiusstrasse 16<br />
                    8006 Zurich<br />
                    <a href="mailto:eureka@eurekamicroscope.com"
                      style={{ color: "rgba(26,42,60,0.45)", textDecoration: "none" }}
                      onMouseEnter={e => { (e.currentTarget).style.color = "rgba(26,42,60,0.9)"; }}
                      onMouseLeave={e => { (e.currentTarget).style.color = "rgba(26,42,60,0.45)"; }}
                ...
                {/* Quick Menu */}
                <div>
                  <div style={{ fontFamily: FONTS.sans, fontWeight: 400, fontSize: "clamp(10px,0.8vw,12px)", letterSpacing: "0.18em", textTransform: "uppercase", color: "rgba(26,42,60,0.5)", marginBottom: 20 }}>Quick Menu</div>
                  <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
                    {["About Us", "Blog"].map(label => (
                      <a key={label} href={`#${label.toLowerCase().replace(" ", "-")}`}
                        style={{ fontFamily: FONTS.sans, fontWeight: 300, fontSize: "clamp(13px,1vw,15px)", color: "rgba(26,42,60,0.45)", textDecoration: "none" }}
                        onMouseEnter={e => { (e.currentTarget).style.color = "rgba(26,42,60,0.9)"; }}
                        onMouseLeave={e => { (e.currentTarget).style.color = "rgba(26,42,60,0.45)"; }}
                      >{label}</a>
                    ))}
                ...
                {/* Socials */}
                <div>
                  <div style={{ fontFamily: FONTS.sans, fontWeight: 400, fontSize: "clamp(10px,0.8vw,12px)", letterSpacing: "0.18em", textTransform: "uppercase", color: "rgba(26,42,60,0.5)", marginBottom: 20 }}>Socials</div>
                  <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
                    {[
